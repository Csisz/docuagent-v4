...
async def update_invoice(
    ...
    try:
        ...
        await _adb.execute(
            """INSERT INTO audit_log (tenant_id, user_id, user_email, action, entity_type, entity_id, details)
               VALUES ($1, $2, $3, 'invoice_update', 'invoice_extraction', $4, $5::jsonb)""",
            tenant_id,
        ...
        log.debug(f"audit_log invoice_update failed: {_ae}")
